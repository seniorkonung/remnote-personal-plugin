...
export const REM_TEXT_TOTALS = 'Итоги';
export const REM_TEXT_SYMPTOMS = 'Симптомы';
export const REM_TEXT_REGIME = 'Режим';
export const REM_TEXT_POMODORO = 'Помидоры';
export const REM_TEXT_RITUALS = 'Ритуалы';
export const REM_TEXT_OTHER = 'Другое';
export const REM_TEXT_QUOTA = 'Квота';
export const REM_TEXT_NOTES = 'Заметки';
export const REM_TEXT_THESIS = 'Тезис';
export const REM_TEXT_RATIONS = 'Рационы';
export const REM_TEXT_CATEGORIES = 'Категории';
export const REM_TEXT_FLASCARDS = 'Флешкарты';
export const REM_TEXT_NEW = 'Новое';
export const REM_TEXT_PRODUCTS = 'Продукты';
export const REM_TEXT_FOR_PORTAL = 'Для портала';
